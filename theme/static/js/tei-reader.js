...
return 0===e.size?u:y([...e])}}function F(...e){let t=e[0],s=e[1],n=e[2]
if(n)return function(e,t,s){let n=U(e)
n.trackedProperties[t]=!0,n.trackedComputedProperties[t]=!0
let i=s.get,r=s.set
return{enumerable:!0,configurable:!1,get:function(){let e=V,s=V=new H,n=i.call(this)
V=e
let r=s.combine()
V&&V.add(r)
...
U(e).trackedProperties[t]=!0,Object.defineProperty(e,t,{configurable:!0,get(){return j(this,t),this[s]},set(e){W.inner.dirty(),U(this).updatableTagFor(t).inner.update(f.create()),this[s]=e,G()}})})(t,s)}let V=null
function j(e,t){V&&V.add(U(e).updatableTagFor(t))}class P{constructor(e){this.tags=s(),this.computedPropertyTags=s(),this.trackedProperties=e?Object.create(e.trackedProperties):s(),this.trackedComputedProperties=e?Object.create(e.trackedComputedProperties):s()}tagFor(e){let t=this.tags[e]
...
class Fe{constructor(e,t,s){this.parentNode=e,this.first=t,this.last=s}parentElement(){return this.parentNode}firstNode(){return this.first}lastNode(){return this.last}}const Ve="http://www.w3.org/2000/svg"
function je(e,t,s){if(!e)return t
if(!function(e,t){let s=e.createElementNS(t,"svg")
try{s.insertAdjacentHTML("beforeend","<circle></circle>")}catch(n){}finally{return 1!==s.childNodes.length||s.firstChild.namespaceURI!==Ve}}(e,s))return t
...
let a=r[0],l=r[1]
return new Fe(e,a,l)}(e,n,i,t)}}}function Pe(e,t){return e&&function(e){let t=e.createElement("div")
...
if(null===n||""===n)return new Fe(r,null,null)
...
return new Fe(r,o,i)}(this.uselessElement,e,t,s)}createTextNode(e){return this.document.createTextNode(e)}createComment(e){return this.document.createComment(e)}}var qe;(function(e){class t extends Ge{createElementNS(e,t){return this.document.createElementNS(e,t)}setAttribute(e,t,s,n=null){n?e.setAttributeNS(n,t,s):e.setAttribute(t,s)}}e.TreeConstruction=t
let s=t
...
class Ht{constructor(e){this.inner=e,this.tag=e.tag}value(){return this.toBool(this.inner.value())}toBool(e){return!!e}}class Ft extends C{constructor(e){super(),this.parts=e,this.tag=b(e)}compute(){let e=new Array
for(let t=0;t<this.parts.length;t++){let s=this.parts[t].value()
null!=s&&(e[t]=Vt(s))}return e.length>0?e.join(""):null}}function Vt(e){return"function"!=typeof e.toString?"":String(e)}_t.add(1,(e,{op1:t})=>{let s=e.stack,n=e.constants.resolveHandle(t)(e,s.pop())
...
function Fs(e,t){return-1!==e.indexOf(t)}function Vs(e,t){return(null===e||Fs(Ms,e))&&Fs(Is,t)}function js(e,t){return null!==e&&(Fs(Ds,e)&&Fs(Hs,t))}function Ps(e,t){return Vs(e,t)||js(e,t)}function zs(e,t,s,n){let i=null
if(null==n)return n
if(Wt(n))return n.toHTML()
i=t?t.tagName.toUpperCase():null
let r=Ut(n)
if(Vs(i,s)){let t=e.protocolForURL(r)
if(Fs(Rs,t))return`unsafe:${r}`}return js(i,s)?`unsafe:${r}`:r}function Us(e,t){let s,n
...
return this.position++,{key:i,value:n,memo:r}}}class Fn{constructor(e,t,s){this.position=0,this.keys=e,this.values=t,this.keyFor=s}isEmpty(){return 0===this.keys.length}next(){let e=this.position,t=this.keys,s=this.values,n=this.keyFor
if(e>=t.length)return null
...
if(Array.isArray(s))return s.length>0?new Hn(s,t):Vn
if(null==s)return Vn
if(void 0!==s.forEach){let e=[]
return s.forEach(function(t){e.push(t)}),e.length>0?new Hn(e,t):Vn}if("object"==typeof s){let e=Object.keys(s)
...
t.shift(),t.push(...e),i.apply(s&&s.value(),t)})}function Hi(e){return e[0]?e[1]:e[2]}class Fi{constructor(e){this.resolver=e}getComponentDefinition(e){let t=this.resolver.resolve(e)
...
return{compile:()=>s.handle,symbolTable:s.symbolTable}}lookupHelper(e,t){return this.resolver.lookupHelper(e,t)}lookupModifier(e,t){return this.resolver.lookupModifier(e,t)}lookupComponentDefinition(e,t){return this.resolver.lookupComponentHandle(e,t)}lookupPartial(e,t){return this.resolver.lookupPartial(e,t)}}class Vi{constructor(e){this.resolver=e}async getTemplateIterator(e,t,s,n,i){let r=new Mi(e),a=new Fi(r),l=new ti,o=new Li(a,r,l),h=o.program
...
r>3&&a&&Object.defineProperty(t,s,a)})([F],Yi.prototype,"hasEntries",null)
...
class Ji extends X{constructor(){super(...arguments),this.showMenu=!1}didInsertElement(){this.textElement=document.querySelector("#tei-reader main")}get navEntries(){let e=[]
return this.args.entries.forEach(t=>{if(e.length>0&&e[e.length-1].id===t.id)e[e.length-1].labels.push({level:t.level,text:t.text})
else{let s={id:t.id,labels:[{level:t.level,text:t.text}]}
e.push(s)}}),e}scrollTo(e){this.textElement.querySelector("*[data-heading-id="+e.id+"]").scrollIntoView({behavior:"smooth",block:"start"})}toggleMenu(e){e.preventDefault(),e.stopPropagation(),this.showMenu=!this.showMenu}}Xi([F],Ji.prototype,"textElement",void 0),Xi([F],Ji.prototype,"showMenu",void 0),Xi([F],Ji.prototype,"navEntries",null)
...
return s.importStylesheet(t),s.transformToDocument(e)}}Ki([F],Qi.prototype,"currentHeadingIdx",void 0),Ki([F],Qi.prototype,"annotationEntries",void 0),Ki([F],Qi.prototype,"navEntries",void 0),Ki([F],Qi.prototype,"textEntries",void 0),Ki([F],Qi.prototype,"loading",void 0),Ki([F],Qi.prototype,"visibleAnnotations",void 0)
...
super({builder:new ji({element:s,nextSibling:null}),loader:new Vi(t),renderer:new Pi,resolver:t,rootName:nr.app.rootName})}}
